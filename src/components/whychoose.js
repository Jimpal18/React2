    ...
    <section className="why-choose-us">
        ...
        <div className="features">
          <div className="feature">
            <img src="/images/innovation.jpg" alt="Sustainable Innovation"></img>
          ...
          <div className="feature">
            <img src="/images/Vectors.png" alt="High-Quality Products"></img>
          ...
          <div className="feature">
            <img src="/images/agriculture.png" alt="Agricultural Impact"></img>
            <h3>Agricultural Impact</h3>
            <p>Boost soil health, crop yield, and water retention with our proven. </p>
          </div>
          <div className="feature">
            <img src="/images/environment.png" alt="Environmental Commitment"></img>
